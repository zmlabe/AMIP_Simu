...
that the first year (1978) is removed due to model spin-up.
...
def readDataM(variable,experiment,level,detrend,sliceeq):
    """
    Function reads monthly data from all 6 AMIP experiments
    ...
    if level == 'surface': # 3d variables
        dataq = Dataset(directorydata + 'AMIP1/monthly/T2M_1978-2016.nc')
