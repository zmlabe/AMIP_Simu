...
This script plots over the Arctic Amplification period (AA; last 15 years).
...
### Define directories
directoryfigure = '/home/zlabe/Desktop/PatternCorr_AA/Detrended/'
...
print('\n' '----Plotting Pattern Correlations for AA- %s----' % titletime)
...
for rr in range(len(varnames)):
    ...
    plt.savefig(directoryfigure + \
                '%s/Correlation_Mean_%s_AA_%s.png' % (period,
                                                           varnames[rr],
                                                           period),dpi=300)